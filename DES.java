...
public class DES implements Code{
	...
	public DES(String key, String outputFileName) throws UnsupportedEncodingException{
		key = pad(toHexString(key));
		this.key = new SecretKeySpec(DatatypeConverter.parseHexBinary(key), "DES");
